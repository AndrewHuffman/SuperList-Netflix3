// ==UserScript==
// @name        Netflix Super Browse 3
// @namespace   AndrewHuffman
// @description Access Netflix Secret Categories (Original by CyrisXD, with additions from pigy & AndrewHuffman)
// @version     1.3
// @grant       GM_addStyle
// @match       *://*.netflix.com/*
...
/**
 * This is a rewrite of the existing userscript edited by "pigy" found on openuser.js
 * Updating to organize code and make it easier to resize the list as it's quite
 * long and frustrating to navigate. May add a little search feature if I get 
 * around to it.
 * 
 * https://openuserjs.org/scripts/blacckpigy/Netflix_Super_Browse2
 */
